  ...
  const userData = useMemo(
    () => ({
      ...
      projects: [
        {
          ...
          id: "428",
          slug: "career-crush-back-end",
        },
        {
          name: "Task App",
          description: "Welcome to the To-Do List App! ",
          languages: ["C#", "SQL Server", "ASP.NET"],
          updatedAt: "2024-02-09T09:49:02.300Z",
          image: "https://images.codefoli.com/320-projects-image-430",
          id: "430",
          slug: "task-app",
        },
        {
          name: "Quotes Web Application",
          description: "Daily motivation quotes",
          languages: ["JavaScript", "ReactJs", "Netlify"],
          updatedAt: "2024-02-09T10:43:45.534Z",
          image: "https://images.codefoli.com/320-projects-image-431",
          id: "431",
          slug: "quotes-web-application",
        },
      ],
      work: [
        {
          ...
          endDate: "Present",
          description:
            "Currently focused on refining and optimizing Java code to enhance overall system efficiency.",
          orderId: 1,
          image: "https://images.codefoli.com/320-job-image-upload-238",
        },
        {
          id: 239,
          company: "Taleas",
          ...
          description:
            "Completed software developer internship with JavaScript, Node.js, React, AWS, and MongoDB.",
          orderId: 2,
          image: "https://images.codefoli.com/320-job-image-upload-239",
        },
        {
          id: 240,
          company: "Coders SHPK",
          ...
          endDate: "May 2023",
          description:
            "Completed internship utilizing Next.js, TypeORM, SQL Server, and JWT for full-stack development.",
          orderId: 3,
          image: "https://images.codefoli.com/320-job-image-upload-240",
        },
        {
          id: 241,
          company: "Yellow Pages Canda",
          position: " Sales Representative",
          startDate: "June 2022",
          endDate: "September 2022",
          description:
            "Experienced Sales Representative proficient in marketing and Google Ads.",
          orderId: 4,
          image: "https://images.codefoli.com/320-job-image-upload-241",
        },
      ],
      role: "USER",
      ...
      slugs: [
        {
          slug: "career-crush-back-end",
          header: "Career Crush Back end",
          description:
            "RESTful API with controllers for handling various requests, user authentication using AWS Cognito User Pool, github checks for continuous integration, automatic deployment from GitHub using AWS CDK, content moderation for user-generated content, image checking using AWS Rekognition for identifying inappropriate images.",
          about:
            "This backend is built using AWS CDK to manage infrastructure components.",
          image: "https://images.codefoli.com/320-project-content-428",
          overview: "Overview",
          platforms: "Web, Android, iOS",
          link: "https://github.com/echomaverick/taleas-project-backend",
        },
        {
          slug: "task-app",
          header: "To Do List Application",
          description:
            "Create, read, update, and delete tasks. Organize tasks with categories, User authentication and authorization.",
          about:
            "Welcome to the To-Do List App! This application is built using C# with the ASP.NET MVC framework.",
          image: "https://images.codefoli.com/320-project-content-430",
          overview: "Overview",
          platforms: "Web",
          link: "https://github.com/echomaverick/ToDoTasks",
        },
        {
          slug: "quotes-web-application",
          header: "Quotes Web Application",
          description:
            "This project is a simple ReactJS application designed to provide users with daily motivation quotes. It's a straightforward tool for individuals seeking daily inspiration or motivation.",
          about: "",
          image: "https://images.codefoli.com/320-project-content-431",
          overview: "Overview",
          platforms: "Web, Android, iOS",
          link: "https://github.com/echomaverick/quotes-website",
        },
      ],
    }),
    []
